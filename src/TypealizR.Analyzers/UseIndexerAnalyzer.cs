...
{
    public const string DiagnosticId = nameof(Core.Diagnostics.DiagnosticsId.TR1000);
    ...
    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => ImmutableArray.Create(Rule); //TODO: #332 Update Microsoft.CodeAnalysis.CSharp, once net 8 / 9 are entering EOL [Rule]
