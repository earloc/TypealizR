...
namespace Some.Root.Namespace {
    ...
    internal static partial class TypealizR_StringFormatter
    {
        ...
        internal static partial bool Extend(bool argument, string extension) => argument;
        internal static partial DateOnly Extend(DateOnly argument, string extension) => argument;
        internal static partial DateTime Extend(DateTime argument, string extension) => argument;
        internal static partial DateTimeOffset Extend(DateTimeOffset argument, string extension) => argument;
        internal static partial decimal Extend(decimal argument, string extension) => argument;
        internal static partial double Extend(double argument, string extension) => argument;
        internal static partial float Extend(float argument, string extension) => argument;
        internal static partial Guid Extend(Guid argument, string extension) => argument;
        internal static partial int Extend(int argument, string extension) => argument;
        internal static partial long Extend(long argument, string extension) => argument;
        internal static partial short Extend(short argument, string extension) => argument;
        internal static partial string Extend(string argument, string extension) => argument;
        internal static partial TimeOnly Extend(TimeOnly argument, string extension) => argument;
        internal static partial uint Extend(uint argument, string extension) => argument;
        internal static partial ulong Extend(ulong argument, string extension) => argument;
        internal static partial Uri Extend(Uri argument, string extension) => argument;
        internal static partial ushort Extend(ushort argument, string extension) => argument;
    }
}