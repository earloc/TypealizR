//HintName: StringTypealizR_Some.Root.Namespace.Groupings_NoCode_WithDuplicates.g.cs
// <auto-generated/>
...
namespace Some.Root.Namespace.TypealizR
{
    ...
    internal partial class StringTypealizR_Some_Root_Namespace_Groupings_NoCode_WithDuplicates
    {
        private readonly IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer;
        public StringTypealizR_Some_Root_Namespace_Groupings_NoCode_WithDuplicates(IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer)
        {
        ...
        internal partial class LogGroup
        {
            private readonly IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer;
            [DebuggerStepThrough]
            public LogGroup(IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer)
            {
                this.localizer = localizer;
            ...
            internal partial class WarningGroup
            {
                private readonly IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer;
                [DebuggerStepThrough]
                public WarningGroup(IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> localizer)
                {
                    this.localizer = localizer;
                }
        /// <summary>
        ...
        public IStringLocalizer<Some.Root.Namespace.Groupings_NoCode_WithDuplicates> Localizer => this.localizer;
    }
}