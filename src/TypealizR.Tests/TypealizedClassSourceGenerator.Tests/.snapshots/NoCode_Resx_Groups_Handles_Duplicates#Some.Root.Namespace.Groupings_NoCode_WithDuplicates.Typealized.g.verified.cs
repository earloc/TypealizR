...
{
    /// <summary>
    /// Wraps a <see cref="IStringLocalizer{Groupings_NoCode_WithDuplicates}"/> and provides properties for typed-access to resources, generated by TypealizR
    /// </summary>
    ...
    internal partial class TypealizedGroupings_NoCode_WithDuplicates
    {
        ...
        /// <summary>
        /// The wrapped <see cref="IStringLocalizer{Groupings_NoCode_WithDuplicates}"/>
        /// </summary>
        /// <returns>The wrapped <see cref="IStringLocalizer{Groupings_NoCode_WithDuplicates}"/>.</returns>
