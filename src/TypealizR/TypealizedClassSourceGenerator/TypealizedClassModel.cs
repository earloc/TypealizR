...
internal class TypealizedClassModel
{
    ...
    public string ToCSharp(Type generatorType) => $$"""
        ...
        namespace {{markerType.Namespace}}.TypealizR
        {
            ...
            /// <summary>
            /// Wraps a <see cref="IStringLocalizer{{{markerType.GlobalFullName}}}"/> and provides properties for typed-access to resources, generated by TypealizR 
            /// </summary>
        ...
        {{groups.Select(x => x.ToNestedCsharp(generatorType, "        ")).ToMultiline(appendNewLineAfterEach: false)}}
                ...
                /// <summary>
                /// The wrapped <see cref="IStringLocalizer{{{markerType.GlobalFullName}}}"/>
                /// </summary>
                /// <returns>The wrapped <see cref="IStringLocalizer{{{markerType.GlobalFullName}}}"/>.</returns>
